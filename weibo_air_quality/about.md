...
.
├── README.md
├── data_processing.Rmd - Data processing using Spark and Sparklyr.
├── data_processing.nb.html
├── datasets
│   ├── exploratory_analysis.Rmd - Exploratory analysis based on a week's data.
│   ├── exploratory_analysis.html - Generated by the RMarkdown file.
│   ├── gadm36_CHN_shp - Shapefiles for the map of the People's Republic of China.
│   └── weiboscope_data - Weiboscope data. Need to be manually downloaded.
│       ├── week1.csv
│       ├── ...
├── final-project-critique - A course assignment for GOV 1005.
│   ├── critique.Rmd
│   └── critique.html
└── weibo_air_quality - Diretory for the Shiny App
    ├── server.R
    └── ui.R
```
